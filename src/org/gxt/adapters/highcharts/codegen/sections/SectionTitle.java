 ...
 *
 */
public final class SectionTitle extends Section {
	public SectionTitle(final HighChartJS parent, final boolean insertDefault) {
		super(parent, insertDefault);
	}

	public SectionTitle(final HighChartJS parent) {
		super(parent);
	}

	@Override
	public SectionKeys getSectionKey() {
		return Section.SectionKeys.SEC_TITLE;
	}
}
