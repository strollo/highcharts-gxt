 ...
 *
 */
public final class SectionTooltip extends Section {
	public SectionTooltip(final HighChartJS parent, final boolean insertDefault) {
		super(parent, insertDefault);
	}

	public SectionTooltip(final HighChartJS parent) {
		super(parent);
	}

	@Override
	public SectionKeys getSectionKey() {
		return Section.SectionKeys.SEC_TOOLTIP;
	}
}
