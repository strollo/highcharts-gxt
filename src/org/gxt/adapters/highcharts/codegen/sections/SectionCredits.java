 ...
 *
 */
public final class SectionCredits extends Section {
	public SectionCredits(final HighChartJS parent) {
		super(parent);
	}

	public SectionCredits(final HighChartJS parent, final boolean insertDefault) {
		super(parent, insertDefault);
	}

	@Override
	public SectionKeys getSectionKey() {
		return Section.SectionKeys.SEC_CREDITS;
	}
