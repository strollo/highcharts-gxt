 ...
 *
 */
public final class SectionSubTitle extends Section {
	public SectionSubTitle(final HighChartJS parent, final boolean insertDefault) {
		super(parent, insertDefault);
	}

	public SectionSubTitle(final HighChartJS parent) {
		super(parent);
	}

	@Override
	public SectionKeys getSectionKey() {
		return Section.SectionKeys.SEC_SUBTITLE;
	}
