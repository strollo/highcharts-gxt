 ...
 *
 */
public final class SectionLoading extends Section {
	public SectionLoading(final HighChartJS parent, final boolean insertDefault) {
		super(parent, insertDefault);
	}

	public SectionLoading(final HighChartJS parent) {
		super(parent);
	}

	@Override
	public SectionKeys getSectionKey() {
		return Section.SectionKeys.SEC_LOADING;
	}
}
